...
5. Verificar: `npm run build`, `npm run lint` y comparación visual contra `references/pantallas/agregar-nino.dc.html` (no hay screenshot).
...
- [ ] Guardar con datos válidos agrega una card a la grilla con nombre, initial, edad derivada de la fecha, avatar y tags allergy desde Alergias.
- [ ] Alergias y Notas médicas son opcionales; sin alergias la card no muestra tags.
- [ ] La card nueva muestra "0 padres vinculados".
