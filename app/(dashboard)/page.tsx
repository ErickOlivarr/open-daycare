...
export default function Home() {
  return (
    <div className="mx-auto w-full max-w-[760px] px-5 pb-14 pt-16 lg:px-10 lg:pb-20 lg:pt-[34px]">
      <div className="mb-6">
        ...
        <p className="mt-[5px] text-[14.5px] text-muted-2">
      ...
      >
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-avatar-orange font-fredoka text-[16px] font-semibold text-white">
          C
        </div>
        <span className="flex-1 text-[15px] text-muted">
          Compartí un momento…
        </span>
        <span className="flex h-[38px] w-[38px] items-center justify-center rounded-[12px] bg-brand-soft text-accent">
          <svg
            width="19"
            height="19"
            viewBox="0 0 24 24"
